...
from router.mall import autobody, user, home, address, good, order, \
    account, platform, vtask, adbrand, video_parse, ai_image_generate, video_to_prompt, video_upload, video_download, wenan_extract
...
def include_routers(app: FastAPI):
    ...
    # 文案提取（zhuceka wenan API）
    app.include_router(mall.wenan_extract.router, prefix='/web/video/wenan', tags=['/web/video/wenan'])
    # # video config (管理端配置)
